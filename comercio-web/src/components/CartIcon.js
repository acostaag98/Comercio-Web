...
export default function CartIcon() {
    ...
    return <div id='cart-icon'>
        <Link to='/cart'><svg width="2em" height="3em" viewBox="0 0 16 16" className="bi bi-cart4" fill="white" xmlns="http://www.w3.org/2000/svg">
